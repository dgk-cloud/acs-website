...
function FAQItem({ question, answer, isOpen, onToggle }: { 
  ...
  return (
    <div className="backdrop-blur-xl bg-slate-800/30 border border-slate-600/30 rounded-xl md:rounded-2xl shadow-[0_4px_20px_rgba(0,0,0,0.4)] hover:shadow-[0_8px_30px_rgba(0,0,0,0.6)] hover:border-slate-500/50 transition-all duration-300">
      <button
        onClick={onToggle}
        className="w-full flex items-center justify-between p-3 md:p-4 lg:p-6 text-left group"
      >
        <span className="text-sm md:text-base lg:text-lg font-medium text-white group-hover:text-slate-200 transition-colors pr-3 md:pr-4">
          {question}
        </span>
        <div className="flex-shrink-0 w-5 h-5 md:w-6 md:h-6 lg:w-8 lg:h-8 bg-white/10 rounded-full flex items-center justify-center group-hover:bg-white/20 transition-all duration-200">
          <svg
      ...
      <div className={`px-3 md:px-4 lg:px-6 pb-3 md:pb-4 lg:pb-6 transition-all duration-300 ease-in-out ${
        isOpen ? "max-h-96 opacity-100" : "max-h-0 opacity-0 overflow-hidden"
      }`}>
        <p className="text-slate-300/80 text-sm md:text-base lg:text-lg leading-relaxed font-light">
          {answer}
        </p>
      </div>
    </div>
...
function FAQSection() {
  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
      <div className="backdrop-blur-xl bg-slate-900/40 border border-slate-700/50 rounded-2xl md:rounded-3xl shadow-[0_10px_60px_-15px_rgba(0,0,0,0.8)] p-4 md:p-6 lg:p-8">
        <div className="flex flex-col lg:flex-row gap-6 md:gap-8 lg:gap-12">
          {/* Left Column */}
          <div className="lg:w-2/5 xl:w-1/3">
            <div className="sticky top-6 md:p-4 lg:p-6">
              <div className="inline-flex items-center gap-2 bg-gradient-to-r from-[#2F74FF]/20 to-[#1E40AF]/20 text-[#2F74FF] px-3 md:px-4 py-1.5 md:py-2 rounded-full text-xs md:text-sm font-light tracking-wide mb-3 md:mb-4 lg:mb-6 backdrop-blur-sm border border-[#2F74FF]/30">
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-light mb-3 md:mb-4 lg:mb-6 leading-tight text-white tracking-tighter">
                Frequently Asked <span className="metallic-text">Questions</span>
              </h2>
              <div className="space-y-3 md:space-y-4">
                <div className="flex items-center gap-2 md:gap-3 text-slate-300/80">
                  <div className="w-1.5 h-1.5 md:w-2 md:h-2 bg-[#2F74FF] rounded-full"></div>
                  <span className="text-sm md:text-base lg:text-lg font-light">Global Object Storage</span>
                </div>
                <div className="flex items-center gap-2 md:gap-3 text-slate-300/80">
                  <div className="w-1.5 h-1.5 md:w-2 md:h-2 bg-[#2F74FF] rounded-full"></div>
                  <span className="text-sm md:text-base lg:text-lg font-light">S3 API Compatibility</span>
                </div>
                <div className="flex items-center gap-2 md:gap-3 text-slate-300/80">
                  <div className="w-1.5 h-1.5 md:w-2 md:h-2 bg-[#2F74FF] rounded-full"></div>
                  <span className="text-sm md:text-base lg:text-lg font-light">Worldwide Distribution</span>
                </div>
              </div>
            </div>
          </div>
...
export default function HomePage() {
  return (
    <div className="min-h-screen relative">
      ...
      {/* Get Started Section */}
      <section id="get-started" className="py-4 md:py-8 px-3 sm:px-4 lg:px-8 relative overflow-hidden">
        {/* Background Elements */}
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-6 md:mb-12">
            <div className="inline-flex items-center gap-2 mb-3 md:mb-4 bg-gradient-to-r from-[#2F74FF]/20 to-[#1E40AF]/20 px-3 md:px-4 py-1.5 md:py-2 rounded-full border border-[#2F74FF]/30 text-xs md:text-sm">
              <div className="w-2 h-2 bg-[#2F74FF] rounded-full animate-pulse"></div>
              <span className="text-[#2F74FF] font-medium">Quick Start Guide</span>
            </div>
            <h2 className="text-xl sm:text-2xl md:text-4xl lg:text-5xl font-light text-white tracking-tighter mb-2 md:mb-4">
            ...
            <p className="text-xs sm:text-sm md:text-lg text-slate-300/90 max-w-2xl md:max-w-3xl mx-auto leading-relaxed">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-8 items-center">
            ...
            <div className="space-y-3 md:space-y-6">
              ...
              <div className="group relative">
                <div className="absolute inset-0 bg-gradient-to-r from-[#2F74FF]/10 to-transparent rounded-xl opacity-0 group-hover:opacity-100 transition-all duration-500 blur-xl"></div>
                <div className="relative flex items-start gap-3 md:gap-4 p-3 md:p-4 rounded-xl border border-slate-700/30 hover:border-[#2F74FF]/50 transition-all duration-300 hover:bg-slate-800/20">
                  <div className="flex-shrink-0 w-8 h-8 md:w-10 md:h-10 bg-gradient-to-br from-[#2F74FF] to-[#1E40AF] rounded-xl flex items-center justify-center text-white font-light text-sm md:text-lg tracking-tight shadow-lg group-hover:scale-110 transition-transform duration-300">
                    1
                  </div>
                  <div className="flex-1">
                    <h3 className="text-sm md:text-lg font-light text-white mb-1 md:mb-2 tracking-tight group-hover:text-[#2F74FF] transition-colors duration-300">Contact ACS for sign-up and get an API Key</h3>
                    <p className="text-slate-300/80 text-xs md:text-sm leading-relaxed">Reach out to our team to get onboarded and receive your credentials.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="group relative">
                ...
                <div className="relative flex items-start gap-3 md:gap-4 p-3 md:p-4 rounded-xl border border-slate-700/30 hover:border-[#2F74FF]/50 transition-all duration-300 hover:bg-slate-800/20">
                  ...
                  <div className="flex-1">
                    <h3 className="text-sm md:text-lg font-light text-white mb-1 md:mb-2 tracking-tight group-hover:text-[#2F74FF] transition-colors duration-300">Make a 1-line change to your code</h3>
                    <p className="text-slate-300/80 text-xs md:text-sm leading-relaxed">Update your endpoint configuration with ACS.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="group relative">
                ...
                <div className="relative flex items-start gap-3 md:gap-4 p-3 md:p-4 rounded-xl border border-slate-700/30 hover:border-[#2F74FF]/50 transition-all duration-300 hover:bg-slate-800/20">
                  ...
                  <div className="flex-1">
                    <h3 className="text-sm md:text-lg font-light text-white mb-1 md:mb-2 tracking-tight group-hover:text-[#2F74FF] transition-colors duration-300">Set your API key and start running</h3>
                    <p className="text-slate-300/80 text-xs md:text-sm leading-relaxed">Configure your credentials and begin using ACS with your existing S3-compatible tools.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-4 md:pt-6">
                <a href="https://calendly.com/acceleratedcloudstorage-sales-doxp/30min" target="_blank" rel="noopener noreferrer" className="group inline-flex items-center gap-2 md:gap-3 bg-gradient-to-r from-[#2F74FF] to-[#1E40AF] hover:from-[#2F74FF]/90 hover:to-[#1E40AF]/90 text-white px-5 md:px-8 py-2.5 md:py-4 rounded-xl font-light text-sm md:text-lg tracking-tight transition-all duration-500 shadow-[0_8px_30px_rgba(47,116,255,0.3)] hover:shadow-[0_16px_48px_rgba(47,116,255,0.45)] hover:scale-105 hover:-translate-y-1">
            ...
            <div className="relative group">
              <div className="absolute inset-0 bg-gradient-to-r from-[#2F74FF]/20 to-[#1E40AF]/20 rounded-2xl blur-2xl opacity-0 group-hover:opacity-100 transition-all duration-700"></div>
              <div className="relative backdrop-blur-sm bg-black/30 p-3 md:p-4 rounded-2xl border border-slate-700/50 hover:border-[#2F74FF]/50 transition-all duration-500 overflow-hidden">
                <div className="bg-slate-900/80 backdrop-blur-xl border border-slate-700/50 rounded-xl shadow-2xl p-4 md:p-5 flex flex-col justify-center min-h-[150px] md:min-h-[180px] group-hover:shadow-[0_20px_60px_rgba(47,116,255,0.2)] transition-all duration-500 overflow-x-auto no-scrollbar">
                  <div className="flex items-center justify-between mb-3 md:mb-4">
                    <div className="flex space-x-2 md:space-x-3">
                      <div className="w-2 h-2 md:w-3 md:h-3 rounded-full bg-red-400 shadow-lg"></div>
                      <div className="w-2 h-2 md:w-3 md:h-3 rounded-full bg-yellow-400 shadow-lg"></div>
                      <div className="w-2 h-2 md:w-3 md:h-3 rounded-full bg-green-400 shadow-lg"></div>
                    </div>
                    <div className="text-xs md:text-sm text-gray-400 font-mono">main.py</div>
                  </div>
                  <div className="text-xs md:text-sm font-mono leading-5 md:leading-6 text-gray-300 space-y-1 md:space-y-2 min-w-[300px] md:min-w-[420px]">

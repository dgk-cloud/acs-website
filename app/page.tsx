  ...
  return (
    <div className="min-h-screen relative">
      ...
      <section className="pt-24 md:pt-32 pb-16 md:pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center mt-8 md:mt-16">
          <div className="mb-4 md:mb-6 inline-flex items-center justify-center gap-2 px-3 md:px-4 py-2 bg-blue-900/30 border border-blue-700/50 text-blue-300 rounded-full text-sm font-medium backdrop-blur-sm hover:bg-blue-900/50 hover:border-blue-600/70 transition-all duration-300 hover:scale-105">
            Worldwide Cloud Object Storage
          </div>

          <h1 className="text-3xl md:text-4xl lg:text-6xl xl:text-7xl font-normal text-white tracking-tighter mb-4 md:mb-6 text-center">
          ...
          <p className="text-lg md:text-xl text-muted-foreground text-balance max-w-3xl mx-auto px-4 text-center">
      ...
      {/* Features Section */}
      <section className="py-12 md:py-12 md:py-12 md:py-20 px-4 sm:px-6 lg:px-8 relative">
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-12 md:mb-12 md:mb-16">
            <h2 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-normal text-white tracking-tight mb-4 md:mb-6">
          ...
          {/* Core Features Grid */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-4 md:gap-6">
            {/* S3 Compatible API */}
            <div className="backdrop-blur-xl bg-slate-900/40 border border-slate-700/50 rounded-2xl overflow-hidden transition-all duration-300 hover:border-[#2F74FF]/50 hover:shadow-[0_8px_30px_rgba(47,116,255,0.2)] hover:scale-105">
              <div className="p-4 md:p-6 md:p-8 flex flex-col h-full">
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-3 h-3 bg-[#2F74FF] rounded-full"></div>
                  <h3 className="text-lg md:text-lg md:text-xl font-light tracking-tight text-white">S3 Compatible API</h3>
                </div>
                <p className="text-slate-300/80 mb-4 md:mb-6 text-sm md:text-base leading-relaxed flex-grow">
                  Work seamlessly with existing AWS SDKs and extensions with a one line code change to the endpoint.
                </p>
                <div className="bg-slate-800/50 rounded-xl p-3 md:p-4 border border-slate-600/30 backdrop-blur-sm">
                  <div className="text-xs md:text-sm text-[#2F74FF] font-mono tracking-wide">
            ...
            <div className="backdrop-blur-xl bg-slate-900/40 border border-slate-700/50 rounded-2xl overflow-hidden transition-all duration-300 hover:border-[#2F74FF]/50 hover:shadow-[0_8px_30px_rgba(47,116,255,0.2)] hover:scale-105">
              <div className="p-4 md:p-6 md:p-8 flex flex-col h-full">
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-3 h-3 bg-[#2F74FF] rounded-full"></div>
                  <h3 className="text-lg md:text-lg md:text-xl font-light tracking-tight text-white">Global Data Distribution</h3>
                </div>
                <p className="text-slate-300/80 mb-4 md:mb-6 text-sm md:text-base leading-relaxed flex-grow">
...
au-nsw (australia, new south wales)
            ...
            <div className="backdrop-blur-xl bg-slate-900/40 border border-slate-700/50 rounded-2xl overflow-hidden transition-all duration-300 hover:border-[#2F74FF]/50 hover:shadow-[0_8px_30px_rgba(47,116,255,0.2)] hover:scale-105">
              <div className="p-4 md:p-6 md:p-8 flex flex-col h-full">
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-3 h-3 bg-[#2F74FF] rounded-full"></div>
                  <h3 className="text-lg md:text-lg md:text-xl font-light tracking-tight text-white">High Performance</h3>
                </div>
                <p className="text-slate-300/80 mb-4 md:mb-6 text-sm md:text-base leading-relaxed flex-grow">
            ...
            <div className="md:col-span-2 backdrop-blur-xl bg-slate-900/40 border border-slate-700/50 rounded-2xl overflow-hidden transition-all duration-300 hover:border-[#2F74FF]/50 hover:shadow-[0_8px_30px_rgba(47,116,255,0.2)] hover:scale-105">
              <div className="p-4 md:p-6 md:p-8 flex flex-col h-full">
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-3 h-3 bg-[#2F74FF] rounded-full"></div>
                  <h3 className="text-lg md:text-lg md:text-xl font-light tracking-tight text-white">Strong Consistency</h3>
                </div>
                <p className="text-slate-300/80 mb-4 md:mb-6 text-sm md:text-base leading-relaxed flex-grow">
            ...
            <div className="backdrop-blur-xl bg-slate-900/40 border border-slate-700/50 rounded-2xl overflow-hidden transition-all duration-300 hover:border-[#2F74FF]/50 hover:shadow-[0_8px_30px_rgba(47,116,255,0.2)] hover:scale-105">
              <div className="p-4 md:p-6 md:p-8 flex flex-col h-full">
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-3 h-3 bg-[#2F74FF] rounded-full"></div>
                  <h3 className="text-lg md:text-lg md:text-xl font-light tracking-tight text-white">Highly Reliable</h3>
                </div>
                <p className="text-slate-300/80 mb-4 md:mb-6 text-sm md:text-base leading-relaxed flex-grow">
      ...
      <section className="py-12 md:py-12 md:py-12 md:py-20 px-4 sm:px-6 lg:px-8 relative">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 md:mb-12 md:mb-16">
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-light text-white tracking-tighter mb-4 md:mb-6">
              Get Started in <span className="metallic-text">Minutes</span>
            </h2>
            <p className="text-lg md:text-xl text-slate-300/90 max-w-3xl mx-auto leading-relaxed px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            <div className="space-y-6 md:space-y-8">
              ...
              <div className="flex items-start gap-4 md:gap-6">
                <div className="flex-shrink-0 w-12 h-12 md:w-16 md:h-16 bg-gradient-to-br from-[#2F74FF] to-[#1E40AF] rounded-2xl flex items-center justify-center text-white font-light text-xl md:text-2xl tracking-tight shadow-lg">
                  1
                </div>
                <div>
                  <h3 className="text-lg md:text-2xl font-light text-white mb-2 md:mb-3 tracking-tight">Contact ACS for sign-up and get an API Key</h3>
                  <p className="text-slate-300/80 text-base md:text-lg leading-relaxed">Reach out to our team to get onboarded and receive your credentials.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 md:gap-6">
                ...
                <div>
                  <h3 className="text-lg md:text-2xl font-light text-white mb-2 md:mb-3 tracking-tight">Make a 1-line change to your code</h3>
                  <p className="text-slate-300/80 text-base md:text-lg leading-relaxed">Update your endpoint configuration with ACS.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 md:gap-6">
                ...
                <div>
                  <h3 className="text-lg md:text-2xl font-light text-white mb-2 md:mb-3 tracking-tight">Set your API key and start running</h3>
                  <p className="text-slate-300/80 text-base md:text-lg leading-relaxed">Configure your credentials and begin using ACS with your existing S3-compatible tools.</p>
                </div>
              </div>

              {/* CTA Button */}
              <div className="pt-6 md:pt-8">
                <a href="https://calendly.com/acceleratedcloudstorage-sales-doxp/30min" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 bg-gradient-to-r from-[#2F74FF] to-[#1E40AF] hover:from-[#2F74FF]/90 hover:to-[#1E40AF]/90 text-white px-6 md:px-10 py-3 md:py-5 rounded-2xl font-light text-lg md:text-xl tracking-tight transition-all duration-300 shadow-[0_8px_30px_rgba(47,116,255,0.3)] hover:shadow-[0_12px_40px_rgba(47,116,255,0.4)] hover:scale-105">
                  Get Started Today
